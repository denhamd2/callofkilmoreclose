...
## 2.0 m over a ~4.55 m slope run is ~24° — concrete interlocking tiles on
## these semis read a touch steeper than the old 1.65 m / 21° pass. Provisional
## facade proportion, not a survey figure.
const ROOF_H := 2.0
